...
class WeddingCadsTemplets02 extends StatelessWidget {
  String templetImag;
  WeddingCadsTemplets02(this.templetImag);

  Color templetTextColor = Color(0xffeeb246);
