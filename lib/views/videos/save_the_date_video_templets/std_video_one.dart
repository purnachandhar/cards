...
class STDVideoOne extends StatelessWidget {
  const STDVideoOne({Key? key}) : super(key: key);
    ...
    return Scaffold(
      body: Center(
        child: Stack(
          ...
          children: [
            Image.network("https://firebasestorage.googleapis.com/v0/b/cards-31f5c.appspot.com/o/wd.gif?alt=media&token=ea686621-ead0-4848-936a-3aed55d89134"),
            Center(
              child: Column(
